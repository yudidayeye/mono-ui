...
export function getPresetPlugins(options: GenerateConfigPluginsOptions = {}) {
  ...
  result.push(
    getPresetPlugin(options, 'pluginVue', vue as any),
    getPresetPlugin(options, 'pluginInspect', inspect),
    getPresetPlugin(options, 'pluginVisualizer', visualizer as any),
    getPresetPlugin(options, 'pluginReplace', replace as any),
  );
...
export function getPlugins(
  ...
  const result = getPresetPlugins(options as GenerateConfigPluginsOptions);
