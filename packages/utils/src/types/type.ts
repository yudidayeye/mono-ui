 ...
 * @LastEditTime: 2024-04-03 11:22:47
 * @FilePath: \mono-ui\packages\utils\src\types\type.ts
 */
import type {
  App, PropType, Plugin, Ref, VNode, SlotsType,
} from 'vue';
/**
 * https://stackoverflow.com/questions/46176165
...
export const withInstall = <T>(comp: T) => {
  const c = comp as any;
  c.install = function install(app: App) {
